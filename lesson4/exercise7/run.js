...
function sortPerformanceInAscOrder(stockarray) {
    return stockarray.sort()
}

// Do not modify this code:
// sortPerformanceInAscOrder(StockDailyPerformance);
console.log(`Sorted daily performance: ${sortPerformanceInAscOrder(StockDailyPerformance)}`)